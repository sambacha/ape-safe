...
class InlineResponse2001(Model):
    ...
    def __init__(self, count: int=None, next: str=None, previous: str=None, results: List[Contract]=None):  # noqa: E501
    ...
    @property
    def results(self) -> List[Contract]:
    ...
    @results.setter
    def results(self, results: List[Contract]):
