...
class InlineResponse2004(Model):
    ...
    def __init__(self, count: int=None, next: str=None, previous: str=None, results: List[SafeModuleTransactionResponse]=None):  # noqa: E501
        ...
        :type results: List[SafeModuleTransactionResponse]
        """
        self.swagger_types = {
            'count': int,
            'next': str,
            'previous': str,
            'results': List[SafeModuleTransactionResponse]
        }
    ...
    @property
    def results(self) -> List[SafeModuleTransactionResponse]:
        """Gets the results of this InlineResponse2004.


        :return: The results of this InlineResponse2004.
        :rtype: List[SafeModuleTransactionResponse]
        """
        return self._results

    @results.setter
    def results(self, results: List[SafeModuleTransactionResponse]):
